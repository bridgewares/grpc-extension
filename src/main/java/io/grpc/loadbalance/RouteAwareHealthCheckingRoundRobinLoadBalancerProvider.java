...
public class RouteAwareHealthCheckingRoundRobinLoadBalancerProvider extends LoadBalancerProvider {

    private final LoadBalancerProvider rrProvider;

    public RouteAwareHealthCheckingRoundRobinLoadBalancerProvider() {
    ...
    static LoadBalancerProvider newRoundRobinProvider() {
        return new RouteAwareLoadBalancerProvider();
    }
}
